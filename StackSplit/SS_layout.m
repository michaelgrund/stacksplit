function h=SS_layout(push1_callback,push2_callback,push3_callback,push4_callback,list_callback,...
    ...
    pop2_callback,pop3_callback,pop4_callback)
%==========================================================================
%##########################################################################
%#                                                                        #
...
if isempty(h.fig)
    ...
    set(h.fig,'position',[150,321,1400,600])
else
    close(h.fig)
    %.........................................
    SS_stacksplit_start;
...
set(h.ev_info,'String',['                  t0time               JD      BAZ     dist      inc     SNR         filter          pha'])
set(h.ev_info,'Position',[45,493,529,15],'fontsize',10)
...
set(h.staname_info,'Position',[790,550,68,22],'fontsize',15)
...
h.panel(1) = uipanel('Units','pixel','Title','Selection window',...
    'FontSize',10,'Position',[14 22 852 568], 'BackgroundColor', [224   223   227]/255);

h.panel(2) = uipanel('Units','pixel','Title','Minimum energy surface',...
    'FontSize',10,'Position',[884 22 502 568], 'BackgroundColor', [224   223   227]/255);
...
h.panel(4)= uipanel('Parent',h.panel(1),'Units','pixel','title','Surface stack',...
    'FontSize',10,'Position',[580 17 119 170], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');

h.panel(5)= uipanel('Parent',h.panel(1),'Units','pixel','title','Joint inversion',...
    'FontSize',10,'Position',[715 86 119 101], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');

h.panel(6) = uipanel('Units','pixel','Title','Waveforms',...
    'FontSize',10,'Position',[884 22 502 568], 'BackgroundColor', [224   223   227]/255);

h.panel(7) = uipanel('Parent',h.panel(1),'Units','pixel',... % panel "around" listbox
    'FontSize',10,'Position',[28,68,534,419], 'BackgroundColor', [224   223   227]/255);

h.panel(8) = uipanel('Parent',h.panel(1),'Units','pixel','Title','Limits',... 
    'FontSize',10,'Position',[600,200,214,90], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');

h.panel(9) = uipanel('Parent',h.panel(1),'Units','pixel','Title','Splits',... 
    'FontSize',10,'Position',[55,500,230,40], 'BackgroundColor', 'w','TitlePosition','centertop');

h.panel(10) = uipanel('Parent',h.panel(1),'Units','pixel','Title','Nulls',... 
    'FontSize',10,'Position',[305,500,230,40], 'BackgroundColor', 'w','TitlePosition','centertop');

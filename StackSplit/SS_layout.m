...
h.panel(4)= uipanel('Parent',h.panel(1),'Units','pixel','title','Surface stack',...
    'FontSize',10,'Position',[580 7 119 170], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');

h.panel(5)= uipanel('Parent',h.panel(1),'Units','pixel','title','Joint inversion',...
    'FontSize',10,'Position',[715 76 119 101], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');
...
h.panel(8) = uipanel('Parent',h.panel(1),'Units','pixel','Title','Limits',... 
    'FontSize',10,'Position',[600,187,214,102], 'BackgroundColor', [224   223   227]/255,'TitlePosition','centertop');
